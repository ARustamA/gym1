...
import a from "./slider2/assets/1.webp";
import b from "./slider2/assets/2.webp";
import c from "./slider2/assets/3.webp";
import d from "./slider2/assets/4.jpg";
import e from "./slider2/assets/5.jpg";
import f from "./slider2/assets/6.jpg";


export const Instructor = () => {
   const imgAr = [
      {id:1,name:"Илья Панченко",position1:"Инструктор тренажерного зала",position2:"Персональный тренер",workEpxp:4,foto:"./slider2/assets/1.webp",},
      {id:2,name:"Екатерина Сосина-Нуньес",position1:"Фитнес-тренер",position2:"Персональный тренер",workEpxp:4,foto:"./slider2/assets/2.webp",},
      {id:3,name:"Юлия Белова",position1:"Фитнес-тренер",position2:"Персональный тренер",workEpxp:4,foto:"./slider2/assets/3.webp",},
      {id:4,name:"Евгения",position1:"Нутрициолог",position2:"Персональный тренер",workEpxp:4,foto:"./slider2/assets/4.jpg",},
      {id:4,name:"Зарипова Людмила",position1:"Иструктор по лечебной гимнастике",position2:"Инструктор по йоге",workEpxp:5,foto:"./slider2/assets/5.jpg",},
      ];
   const length = imgAr.length-1;
   return (
      <div id='instructor'>
         <div className={style.container}>
            ...
            <a href='#information' className={style.arrowDawn}>
